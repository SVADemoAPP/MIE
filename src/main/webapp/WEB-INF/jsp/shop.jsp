							...
							<div class="panel-body"style="border-color: #71d398;">
								<div id="divCon1" style="text-align: center;">
									<div id="mapContainer1" class="demo-wrapper">
										<div id="heatmap1" class="heatmap" style="height: 400px">
		                                </div>										
										</div>
									</div>
								</div>
		         ...
		         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="panel-teal toggle">
                              ...
                              <div class="panel-body">
                                ...
                                <h1  id="loadingId"class="loadingtext" style="display:none;margin-top: -200px;position: absolute;margin-left: 40%;">
                                  <span>加</span>
                                  <span>载</span>
                                  <span>中</span>
                                  <span>请</span>
