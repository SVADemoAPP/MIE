...
<head>
<meta charset="utf-8">
<title><spring:message code="category_config"></spring:message></title>
...
<body>
			...
			<ul id="sideNav" class="nav nav-pills nav-stacked">
				...
				<li><a class="active-state expand" href="#"><spring:message
					...
					<ul class="nav sub show">
						...
						<li><a class="active"
							href="<c:url value='/home/categoryMng'/>"><i class="im-wand"></i>
						...
						<div class="col-lg-12 col-md-12">
							<div class="panel panel-success toggle  ">
								...
								<div class="panel-body">
									<form id="formId" action="../category/api/saveCategory" method="post">
											...
											<div class="col-lg-12 col-md-12 " style="height: 40px;">
												<label
													...
													class="col-lg-2 col-md-2 control-label"><spring:message
														code="category_name"></spring:message></label>
												<div class="col-lg-4 col-md-4">
													<input type="text"
														style="border-color: #71d398; width: 60%; float: left;"
														id="categoryId" class="form-control" name="name"
														placeholder="<spring:message code="category_name"></spring:message>">
												</div>
												</select> <input type="hidden" name="id" id="idid"> <label
													style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
													class="col-lg-2 col-md-2 control-label"><spring:message
														code="EnteringRange"></spring:message></label>
												<div class="col-lg-4 col-md-4">
													<a style="width: 16%;">x:</a> <input type="text" name="x"
														maxlength="15" style="width: 18%; height: 28px;" id="x"
														onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" />
													<a style="width: 16%; margin-left: 2%;">y:</a> <input
														type="text" name="y" maxlength="15"
														style="width: 18%; height: 28px;" id="y"
														onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" />
												</div>
											</div>
											<div class="col-lg-12 col-md-12 " style="height: 40px;">
												<label
													style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
													class="col-lg-2 col-md-2 control-label"><spring:message
														code="deepTime"></spring:message></label>
												<div class="col-lg-4 col-md-4">
													<input type="text"
														onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')"
														style="border-color: #71d398; width: 60%; float: left;"
														id="deepTime" class="form-control" name="deepTime"
														placeholder="<spring:message code="deepTime"></spring:message>">
												</div>
												<label
													style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
													class="col-lg-2 col-md-2 control-label"><spring:message
														code="visitorNumber"></spring:message></label>
												<div class="col-lg-4 col-md-4">
													<input type="text"
														onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')"
														style="border-color: #71d398; width: 60%; float: left;"
														id="visitorNumber" class="form-control" name="visitorNumber"
														placeholder="<spring:message code="visitorNumber"></spring:message>">
												</div>
											</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-6"
											...
											<button style="" id="Confirm" type="button"
												class="btn btn-success">
												<spring:message code="category_confirm"></spring:message>
											</button>
											<button style="" id="Cancel" type="button"
												class="btn btn-success">
												<spring:message code="category_cancel"></spring:message>
											</button>
										</div>
									</form>
								</div>
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default plain toggle ">
						...
						<div class="panel-body">
							...
							<table class="table display" id="cate-datatable">
								<thead>
									<tr>
										<th></th>
										...
										<th>X</th>
										<th>Y</th>
										<th><spring:message code="deepTime"></spring:message></th>
										<th><spring:message code="visitorNumber"></spring:message></th>
	...
	<script src="../js/config/categoryMng.js"></script>
	<script src="../js/cmdrun.js"></script>
	...
	<script type="text/javascript">
        ...
        inotnull = '<spring:message code="map_not_null"/>',
        inotshuzi = '<spring:message code="ticket_shuziformat"/>',
        inotsame = '<spring:message code="ticket_same"/>',

		idelete = '<spring:message code="store_delete"/>', notnull = '<spring:message code="category_not_null"/>', exist = '<spring:message code="category_exists"/>', isearch = '<spring:message code="mall_search"/>', ientries = '<spring:message code="mall_entries"/>';
		var home = '<spring:message code="home"/>';
		var oTable;
		$(document).ready(function() {
			Category.bindClickEvent();
			Category.initTable();
			initPieChart();
		});
