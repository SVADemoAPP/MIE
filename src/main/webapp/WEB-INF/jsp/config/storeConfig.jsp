...
<head>
<meta charset="utf-8">
<title><spring:message code="store_config"></spring:message></title>
...
<body>
			...
			<div class="navbar">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"> <img
							class="user-avatar" src="../plugins/newJs/img/avatars/48.jpg" alt="${sessionScope.userName}">${sessionScope.userName}
					</a>
			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="ec-pencil2"></i><spring:message code="store_config"></spring:message>
					</h1>
					<!-- Start .bredcrumb -->
			...
			<div class="outlet">
				<div id="editBox" class="myhide">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div
								class="panel panel-success toggle  ">
								<!-- Start .panel -->
								<div class="panel-heading">
									<h4 class="panel-title"><spring:message code="store_config"></spring:message></h4>
								</div>
								<div class="panel-body">
								<form action="/sva/market/api/saveData" method="post">
									<div class="form-group has-success">
										<label
											style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
											class="col-lg-2 col-md-2  control-label"><spring:message code="mall_name"></spring:message>
											</label>
										<div class="col-lg-10 col-md-10 ">
											<div class="col-lg-10 col-md-12 ">
												<input type="text" style="border-color: #71d398;width: 70%;float:left"
												class="form-control" id="storeName" name="name" placeholder="<spring:message code="mall_name"></spring:message>">
											</div>
										</div>
		                                 <div class="myhide">
										...
										<div class="col-lg-12 col-md-12 "
											...
											<button style="" id="confirm" type="button" class="btn btn-success"><spring:message code="store_confirm"></spring:message></button>
											<button style="" id="cancel" type="button" class="btn btn-success"><spring:message code="store_cancle"></spring:message></button>
										</div>
									</div>
								</form>	
								</div>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div
							class="panel panel-default plain toggle  ">
							<!-- Start .panel -->
	...
	<script src="../js/config/storeConfig.js"></script>
	...
	var iedit = '<spring:message code="store_edt"/>',
        ...
        ipass = '<spring:message code="ticket_pass"/>',
        isame = '<spring:message code="mall_same"/>',
