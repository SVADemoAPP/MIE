...
<head>
<meta charset="utf-8">
<title><spring:message code="ticket_config"></spring:message></title>
...
<body>
			...
			<ul id="sideNav" class="nav nav-pills nav-stacked">
				...
				<li class="hasSub"><a class="active-state expand" href="#"><spring:message
					...
					<ul class="nav sub show">
						...
						<li><a class="active" href="<c:url value='/home/ticketMng'/>"><spring:message
			...
			<div class="row">
				...
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="st-chart"></i>
						<spring:message code="ticket_config"></spring:message>
					</h1>
					<!-- Start .bredcrumb -->
						...
						<div class="col-lg-12 col-md-12">
							<div class="panel panel-success toggle  ">
								...
								<div class="panel-body">
									<form action="/sva/ticket/api/saveData" method="post"
												...
												<div class="row">
													<div class="col-lg-6 col-md-6">
														...
														<div class="col-lg-8 col-md-8">
															<select id="storeId" name="storeName"
																class="form-control"
													...
													<div class="col-lg-6 col-md-6">
														<label
															style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
															class="col-lg-3 col-md-3 control-label"><spring:message
																code="ticket_path"></spring:message></label>
														<div class="col-lg-8 col-md-8">
															<div class="col-lg-3 col-md-3">
																<input id="ticketId" name="ticketName"
																	disabled="disabled" type="text"
																	style="border-color: #71d398; margin-left: -15px;"
																	class="form-control">
															</div>
															<div class="col-lg-8 col-md-8 ">
																<input type="file" id="ticketFile" name="tickeFile"
																	class="form-control hide" style="position: fixed;">
																<input type="text" class="form-control file-upload "
																	style="width: 0px; padding: 0px 0px; margin-right: 0px"
																	disabled="disabled"> <label for="ticketFile"
																	style="float: left; width: 50%" id="selectId"
																	class="btn btn-primary"> <i
																	class="fa-plus-sign"></i> <span><spring:message
																			code="map_select"></spring:message></span>
																</label>
																<!--  <input type="file" id="ticketFile" name="tickeFile" style="width: 39%;"class="form-control"> -->
															</div>
														</div>
													</div>
												</div>
											...
											<div class="col-lg-12 col-md-12 " style="height: 40px;">
												<div class="row">
													<div class="col-lg-6 col-md-6">
														...
														<div class="col-lg-8 col-md-8">
															<select id="floorId" name="floorName"
																class="form-control"
																style="border-color: #71d398; width: 55%; float: left">
															</select>
														</div>
													...
													<div class="col-lg-6 col-md-6">
														<label
															style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
															class="col-lg-3 col-md-3 control-label"><spring:message
																code="ticket_gailv"></spring:message></label>
														<div class="col-lg-8 col-md-8">
															<input id="chanceId" name="chanceName" type="text"
												...
												<div class="row">
													<div class="col-lg-6 col-md-6">
														<label
															style="color: #71d398; text-align: center; margin-top: 6px; font-size: 16px;"
															class="col-lg-3 col-md-3 control-label"><spring:message
																code="ticket_shop_name"></spring:message></label>
														<div class="col-lg-8 col-md-8">
															<select id="shopId" name="shopName" class="form-control"
																style="border-color: #71d398; width: 55%; float: left">
															</select>
														</div>
													</div>
								...
								<table class="table display" id="table">
									<thead>
										<tr>
											...
											<th><spring:message code="ticket_shop_name"></spring:message></th>
											<th><spring:message code="ticket_path"></spring:message></th>
											<th><spring:message code="ticket_gailv"></spring:message></th>
	...
	<script src="<c:url value='/js/config/ticketConfig.js'/>"
