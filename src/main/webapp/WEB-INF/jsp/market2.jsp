	...
	<div id="content">
		...
		<div class="content-wrapper" >
			...
			<div class="outlet" style="font-size: 15px;">
						...
						<div class="panel-default toggle">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										...
										<div class="tile gray-spr m0 mb20"
											style="background-color: #f68484; color: white">
											<div class="tile-content text-center clearfix">
												...
												<div class="spark clearfix">
													<div id="nowPeopleId" class="percent"></div>
								...
								<!--<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
										...
										<div class="tile gray-spr m0 mb20"
											style="background-color: #75b9e6; color: white">
											<div class="tile-content text-center clearfix">
												<div class="label" style="color: white">
												...
												<div class="spark clearfix">
													<div id="newPeopleId" class="percent"></div>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<!-- col-lg-3 start here -->
										<div class="tile gray-spr m0 mb20"
											style="background-color: #71d398; color: white">
											<div class="tile-content text-center clearfix">
												<div class="label" style="color: white">
												...
												<div class="spark clearfix">
													<div id="nowAllcountId" class="percent"></div>
													<div id="allDataId"
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<!-- col-lg-3 start here -->
										<div class="tile gray-spr m0 mb20"
											style="background-color: #97d3c5; color: white">
											<div class="tile-content text-center clearfix">
												<div class="label" style="color: white">
												...
												<div class="spark clearfix">
													<div id="nowTimeId" class="percent"></div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-12" style="padding: 0 0px 0px 5px;">
						<!-- Start col-lg-6 -->
						<div class="panel-success toggle">
							<!-- Start .panel -->
							<div class="panel-heading" style="background-color: #71d398; color: white; border-color: #71d398">
								<h4 class="panel-title"style="font-size: 15px;color: white;">
									<i class="im-accessibility"></i>
									<spring:message code="mall_floor_visitors"></spring:message>
								</h4>
							</div>
							<div class="panel-body" style="">
								<div id="divCon" style="text-align: center;">
									<div id="mapContainer" class="demo-wrapper">
										<div id="mall_floor_visitors" style="height: 400px"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-12" style="padding: 0px 5px 0px 0px;">
						<!-- Start col-lg-6 -->
						<div class="panel-success toggle">
							<!-- Start .panel -->
							...
							<div class="panel-body" style="">
								<div id="divCon" style="text-align: center;">
									<div id="mapContainer" class="demo-wrapper">
										<div id="mall_shop_visitors" style="height: 400px"></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="panel-default toggle">
							...
							<div class="panel-body">
								<div id="autoupdate-chart" style="width: 100%; height: 350px;"></div>
							</div>
						</div>
						<!-- End .panel -->
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 left-css">
						<!-- Start col-lg-6 -->
						<div class="panel-danger plain toggle ">
							<!-- Start .panel -->
							<div class="panel-heading"
								style="background-color: #f68484; color: white; border-color: #f68484">
								<h4 class="panel-title" style="font-size: 15px; color: white;">
									<i class="fa-group"></i>
					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="panel-teal toggle  ">
							...
							<div class="panel-heading">
								<h4 class="panel-title" style="font-size: 15px; color: white;">
									<i class="im-bars"></i>
									<spring:message code="echart_tongji"></spring:message>
								</h4>
							</div>
							<div class="panel-body">
				...
				<div class="row">
					<!--  <div class="col-lg-6 col-md-12">
                        <div class="panel panel-primary plain toggle">
                            <div class="panel-heading">
                                <h4 class="panel-title"><i class="im-bars"></i><spring:message code="echart_route"></spring:message></h4>
                            </div>
                            <div class="panel-body">
						...
						<div
							...
							<div class="panel-body blue-bg text-center">
								...
								<p class="weather-location">
									<strong id="date_0"></strong> <span id="week_0"></span>
								</p>
								<p class="weather-location">
