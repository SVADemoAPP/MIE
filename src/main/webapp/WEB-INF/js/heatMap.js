...
var heatMap = function() {
	...
	var intiHeatMapChart = function() {
		$.post("/sva/heatmap/api/getShopHeatMap?shopId=" + shopIds, function(
			...
			document.getElementById("nowPeople").innerHTML = '<i class="ec-users"></i>'
				+heatMapData[heatMapData.length - 1][1];
			function update() {
...
//										yesNewPeople, 0, 1);
								...
								document.getElementById("countYesterday").innerHTML = nowArray[nowArray.length-1];
								...
								document.getElementById("countYesTodayTime").innerHTML = timeToVarchar(timeArray[timeArray.length-1]);
